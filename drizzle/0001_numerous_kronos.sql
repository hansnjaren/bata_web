...
CREATE TABLE "character" (
	...
	"ue2" boolean DEFAULT false NOT NULL,
...
CREATE TABLE "enemies" (
	"id" serial PRIMARY KEY NOT NULL,
	"name" text NOT NULL,
	CONSTRAINT "enemies_name_unique" UNIQUE("name")
);
--> statement-breakpoint
...
CREATE TABLE "skills" (
	...
	"delays" double precision[] DEFAULT '{}' NOT NULL,
...
ALTER TABLE "skills" ADD CONSTRAINT "skills_character_id_character_id_fk" FOREIGN KEY ("character_id") REFERENCES "public"."character"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "character_id_idx" ON "skills" USING btree ("character_id");--> statement-breakpoint
